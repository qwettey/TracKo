...
const Header: React.FC<HeaderProps> = ({ onNewOrder, onImport, onMenuToggle, onNavigateHome }) => {
  return (
    <header className="bg-white border-b border-slate-100 sticky top-0 z-40 w-full">
      <div className="w-[95%] mx-auto h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            onClick={onNewOrder}
            className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white px-5 py-2.5 rounded-xl font-semibold shadow-md shadow-teal-100 transition-all active:scale-95 group"
          >
